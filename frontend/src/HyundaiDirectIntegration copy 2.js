// HyundaiDirectIntegration.js
// 现代汽车智能客服系统 - 本地API集成版本
...
class HyundaiLocalAPIClient {
  ...
  async uploadDocument(knowledgeBaseId, file) {
    ...
    return this.request(`/api/v1/datasets/${knowledgeBaseId}/documents`, {
      method: 'POST',
  ...
  async parseDocuments(knowledgeBaseId, documentIds = []) {
    return this.request(`/api/v1/datasets/${knowledgeBaseId}/chunks`, {
      method: 'POST',
      body: JSON.stringify({
...
const HyundaiDirectIntegration = () => {
  ...
  const [serverMode, setServerMode] = useState('unknown'); // 'production' | 'mock' | 'unknown'
  ...
  const renderChat = () => (
    <div className="flex h-full">
      ...
      <div className="w-64 bg-white shadow-lg border-r">
        ...
        <div className="p-4">
          <button className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg mb-6 flex items-center justify-center">
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <span>服务器地址</span>
            <span className="text-gray-600 font-mono">http://localhost:5000</span>
          </div>
